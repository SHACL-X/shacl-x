...
public class SHACLUtil {
    ...
    private final static Set<Resource> classesWithDefaultType = new HashSet<>();
    ...
    private static final Query propertyLabelQuery = ARQFactory.get().createQuery(
    ...
    public static List<Property> getAllPropertiesOfClass(Resource cls) {
        List<Property> results = new LinkedList<>();
     ...
     * The shapes Model is the union of the input dataset with all graphs referenced via
