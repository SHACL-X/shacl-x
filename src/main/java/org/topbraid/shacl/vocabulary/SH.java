...
public class SH {
    ...
    public final static Resource PyConstraint = ResourceFactory.createResource(NS + "PyConstraint");

    public final static Resource PyConstraintComponent = ResourceFactory.createResource(NS + "PyConstraintComponent");

    public final static Resource PyExecutable = ResourceFactory.createResource(NS + "PyExecutable");

    public final static Resource PyFunction = ResourceFactory.createResource(NS + "PyFunction");

    public final static Resource PyLibrary = ResourceFactory.createResource(NS + "PyLibrary");

    public final static Resource PyRule = ResourceFactory.createResource(NS + "PyRule");

    public final static Resource PyTarget = ResourceFactory.createResource(NS + "PyTarget");

    public final static Resource PyTargetType = ResourceFactory.createResource(NS + "PyTargetType");

    public final static Resource PyValidator = ResourceFactory.createResource(NS + "PyValidator");
    ...
    public final static Property py = ResourceFactory.createProperty(NS + "py");

    public final static Property pyFunctionName = ResourceFactory.createProperty(NS + "pyFunctionName");

    public final static Property pyLibrary = ResourceFactory.createProperty(NS + "pyLibrary");

    public final static Property pyLibraryURL = ResourceFactory.createProperty(NS + "pyLibraryURL");
