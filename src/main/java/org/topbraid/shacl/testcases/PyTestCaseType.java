...
public class PyTestCaseType extends TestCaseType {

    public PyTestCaseType() {
        super(DASH.PyTestCase);
    }


    @Override
    protected TestCase createTestCase(Resource graph, Resource resource) {
        return new PyTestCase(graph, resource);
    }


    private static class PyTestCase extends TestCase {

        PyTestCase(Resource graph, Resource resource) {
