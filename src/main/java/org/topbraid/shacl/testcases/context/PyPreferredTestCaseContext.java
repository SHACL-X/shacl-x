...
/**
 * A TestCaseContext in which Python execution is preferred over SPARQL.
 *
 * @author Holger Knublauch
 */
public class PyPreferredTestCaseContext implements TestCaseContext {
    ...
    public static TestCaseContextFactory getTestCaseContextFactory() {
        return new TestCaseContextFactory() {
            ...
            public TestCaseContext createContext() {
                return new PyPreferredTestCaseContext();
            }
        };
    }
    ...
    public void setUpTestContext() {
        ...
        SHACLPreferences.setPyPreferred(true);
