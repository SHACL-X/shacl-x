...
import org.topbraid.shacl.validation.py.PyConstraintExecutor;
import org.topbraid.shacl.validation.py.PyValidationLanguage;
...
public class ConstraintExecutors {
    ...
    public ConstraintExecutors() {
        ...
        addLanguage(PyValidationLanguage.get());
    }
    ...
    public void setPyPreferred(boolean value) {
        ...
        languages.remove(0);
        if (value) {
            languages.add(0, PyValidationLanguage.get());
            languages.add(1, JSValidationLanguage.get());
