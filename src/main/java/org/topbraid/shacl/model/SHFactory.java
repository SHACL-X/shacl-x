...
public class SHFactory {
    ...
    private static void init(Personality<RDFNode> p) {
        ...
        p.add(SHPyConstraint.class, new SimpleImplementation(SH.PyConstraint.asNode(), SHPyConstraintImpl.class));
        p.add(SHPyExecutable.class, new SimpleImplementation(SH.PyExecutable.asNode(), SHPyExecutableImpl.class));
        p.add(SHPyFunction.class, new SimpleImplementation(SH.PyFunction.asNode(), SHPyFunctionImpl.class));
    ...
    public static SHPyConstraint asPyConstraint(RDFNode node) {
        return node.as(SHPyConstraint.class);
    }
    ...
    public static boolean isPyTarget(RDFNode node) {
        return node instanceof Resource && JenaUtil.hasIndirectType((Resource) node, SH.PyTarget);
    }
