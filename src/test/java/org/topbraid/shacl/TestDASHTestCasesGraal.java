...
public class TestDASHTestCasesGraal {
                ...
                return new GraalScriptEngine() {
                    ...
                    protected Reader createScriptReader(String url) throws Exception {
                        if (DASH_JS.equals(url)) {
                            ...
                            return new InputStreamReader(GraalScriptEngine.class.getResourceAsStream(url.substring(21)));
                        } else {
    ...
    public TestDASHTestCasesGraal(TestCase testCase) {
